...
const LoginScreen: React.FC<Props> = ({ datas, navigatePage }: Props) => {
                    ...
                    <View style={styles.SectionStyle}>
                      <View style={styles.SectionStyleText}>
                        <TextInput
                          ...
                          onChangeText={() => {}}
                          placeholder={'Digite seu login'} //dummy@abc.com
                    ...
                    <View style={styles.SectionStyle}>
                      <View style={styles.SectionStyleText}>
                        <TextInput
                          ...
                          onChangeText={() => {}}
                          placeholder={'Digite sua senha'} //dummy@abc.com
                          placeholderTextColor="rgba(52, 52, 52, 0.6)"
                          autoCapitalize="none"
                          keyboardType="email-address"
                          returnKeyType="next"
