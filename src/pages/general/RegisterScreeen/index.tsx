...
const RegistroScreen: React.FC<Props> = ({ datas, navigatePage }: Props) => {
        ...
        <ImageBackground source={BG_IMAGE} style={styles.bgImage}>
          <KeyboardAvoidingView enabled>
            ...
            <View style={styles.mainBody}>
              <Text style={styles.Recupera}>Registro de Usuário</Text>
              <ScrollView keyboardShouldPersistTaps="handled">
                ...
                <View>
                  ...
                  <View style={styles.SectionFrame}>
                    <Text style={styles.Login}>Nome </Text>
                    {/* USER */}
                    <View style={styles.SectionStyle}>
                      <View style={styles.SectionStyleText}>
                        <TextInput
                          ...
                          onChangeText={() => {}}
                          placeholder={'Digite seu Nome'} //dummy@abc.com
                    ...
                    <View style={styles.SectionStyle}>
                      <View style={styles.SectionStyleText}>
                        <TextInput
                          style={styles.inputStyleUsuario}
                          onChangeText={() => {}}
                          placeholder={'Digite o seu Email'} //dummy@abc.com
                          placeholderTextColor="rgba(52, 52, 52, 0.6)"
                          autoCapitalize="none"
                          keyboardType="email-address"
                          returnKeyType="next"
                    ...
                    <Text style={styles.Login}>Confirmar Email </Text>
                    {/* USER */}
                    <View style={styles.SectionStyle}>
                      <View style={styles.SectionStyleText}>
                        <TextInput
                    ...
                    <Text style={styles.Senha}>Cadastrar Senha </Text>
                    <View style={styles.SectionStyle}>
                      <View style={styles.SectionStyleText}>
                        <TextInput
                          style={styles.inputStyleContraseña}
                          onChangeText={() => {}}
                          placeholder={'Digite uma senha'} //dummy@abc.com
                          placeholderTextColor="rgba(52, 52, 52, 0.6)"
                          autoCapitalize="none"
                          keyboardType="email-address"
                          returnKeyType="next"
