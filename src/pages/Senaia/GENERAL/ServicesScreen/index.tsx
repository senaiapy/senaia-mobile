                      ...
                      <View style={styles.groupButton}>
                        <TouchableOpacity
                          onPress={() => {
                            ...
                            navigateToPages('ModelMessage', 'Track');
                          }}
                          style={{
                        ...
                        >
                          <Image
                            source={require('@/assets/images/Core/track.png')}
                            style={{
                              width: '50%',
                              height: 70,
                              resizeMode: 'contain',
                      ...
                      <View style={styles.groupButton}>
                        <TouchableOpacity
                          onPress={() => {
                            ...
                            navigateToPages('ModelMessage', 'Puesto');
                          }}
                          style={{
                            backgroundColor: '#474887',
                            width: '80%',
                        ...
                        >
                          <Image
                            source={require('@/assets/images/Core/control.png')}
                            style={{
                              width: '50%',
                              height: 70,
                              resizeMode: 'contain',
                          ...
                          >
                            {translate('services.PuestoControl')}
                          </Text>
                        </TouchableOpacity>
                      </View>
                      <View style={styles.groupButton}>
                        <TouchableOpacity
                          onPress={() => {
                            ...
                            navigateToPages('ModelMessage', 'ProfServices');
                          }}
                          style={{
                            backgroundColor: '#474887',
                            width: '80%',
                        ...
                        >
                          <Image
                            source={require('@/assets/images/Core/profservices.png')}
                            style={{
                              width: '50%',
                              height: 70,
                              resizeMode: 'contain',
                          ...
                          >
                            {translate('services.Profesionales')}
                          </Text>
                        </TouchableOpacity>
                      </View>
                      ...
                      <View style={styles.groupButton}>
                        <TouchableOpacity
                          onPress={() => {
                            ...
                            navigateToPages('ModelMessage', 'Productos');
                          }}
                          style={{
                            backgroundColor: '#474887',
                            width: '80%',
                        ...
                        >
                          <Image
                            source={require('@/assets/images/Core/cow.png')}
                            style={{
                              width: '50%',
                              height: 70,
                              margin: 10,
