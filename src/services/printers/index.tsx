...
*/
  ...
  const _renderOther = () => (
    <>
      <Text>Seleccione Impressora: </Text>
      <Picker
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.section}>
        <Text style={styles.title}>Seleccione Tipo: </Text>
        <Picker
      ...
      <View style={styles.section}>
        ...
        {selectedValue === 'net' ? _renderOther() : _renderOther()}
        {/* Buttons Connect */}
        <View
          style={[
        ...
        >
          ...
          >
            <AntIcon name={'settings'} color={'white'} size={18} />
            <Text style={styles.text}>Connecta</Text>
          </TouchableOpacity>
        </View>
        {/* Button Print sample */}
        <View style={styles.buttonContainer}>
          ...
          >
            ...
            <Text style={styles.text}>Imprime Teste</Text>
          </TouchableOpacity>
        </View>
        {/* Button Print bill */}
        <View style={styles.buttonContainer}>
          ...
          >
            <AntIcon name={'arrow-up'} color={'white'} size={18} />
            <Text style={styles.text}>Imprime Factura</Text>
          </TouchableOpacity>
        </View>
        ...
        <View style={styles.buttonContainer}>
          ...
          >
            <AntIcon name={'archive'} color={'white'} size={18} />
            <Text style={styles.text}>Desliga Impresora</Text>
          </TouchableOpacity>
        </View>
        <View style={styles.qr}>
          <QRCode
            value="www.pyfoundation.org"
