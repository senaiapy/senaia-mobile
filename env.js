...
const client = z.object({
  ...
  EXPO_PUBLIC_API_URL_FEED: z.string(),
  EXPO_PUBLIC_API_URL_G: z.string(),
  EXPO_PUBLIC_SYNC_API_URL: z.string(),
  EXPO_PUBLIC_API_API: z.string(),
  EXPO_PUBLIC_AESKEY: z.string(),

  SECRET_KEY: z.string(),
  DB_VERSION: z.string(),
  EXPO_PUBLIC_API_HTTP: z.string(),
  EXPO_PUBLIC_API_WDB: z.string(),
  EXPO_PUBLIC_API_SENAIA: z.string(),
  APPINIT: z.string(),
  KERNEL: z.string(),
  DEBUG: z.string(),
  POSITION: z.string(),
  APPCOMPANY: z.string(),
  EXPO_PUBLIC_baseURL: z.string(),
  WHATSPHONE: z.string(),
...
const _clientEnv = {
  ...
  EXPO_PUBLIC_AESKEY: process.env.EXPO_PUBLIC_AESKEY,

  // ADD YOUR ENV VARS HERE TOO
  EXPO_PUBLIC_API_URL: process.env.EXPO_PUBLIC_API_URL,
  EXPO_PUBLIC_API_URL_FEED: process.env.EXPO_PUBLIC_API_URL_FEED,
  EXPO_PUBLIC_API_URL_G: process.env.EXPO_PUBLIC_API_URL_G,
  EXPO_PUBLIC_SYNC_API_URL: process.env.EXPO_PUBLIC_SYNC_API_URL,
  EXPO_PUBLIC_API_API: process.env.EXPO_PUBLIC_API_API,

  SECRET_KEY: process.env.SECRET_KEY,
  DB_VERSION: process.env.DB_VERSION,
  EXPO_PUBLIC_API_HTTP: process.env.EXPO_PUBLIC_API_HTTP,
  EXPO_PUBLIC_API_WDB: process.env.EXPO_PUBLIC_API_WDB,
  EXPO_PUBLIC_API_SENAIA: process.env.EXPO_PUBLIC_API_SENAIA,
  APPINIT: process.env.APPINIT,
  KERNEL: process.env.KERNEL,
  DEBUG: process.env.DEBUG,
  POSITION: process.env.POSITION,
  APPCOMPANY: process.env.APPCOMPANY,
  EXPO_PUBLIC_baseURL: process.env.EXPO_PUBLIC_baseURL,
